...
import cl.cgs.suitermes.afpcore.db.DbData;
...
import cl.cgs.suitermes.afpcore.db.DbFondoRepo;
import cl.cgs.suitermes.afpcore.db.DbInfo;
import cl.cgs.suitermes.afpcore.db.DbInfoRepo;
import cl.cgs.suitermes.afpcore.db.DbPeriod;
import cl.cgs.suitermes.afpcore.db.DbPeriodRepo;
...
public class DbStarter {
    ...
    public void start(File dataDir) {
        try {
            ...
            File dir = new File(dataDir, "rentabilidad");
